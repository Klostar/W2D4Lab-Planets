...
class TestStarSystem < Minitest::Test
  ...
  def test_get_names_of_planet_with_more__than_one_moons
    expected_names = ["Jupiter","Mars", "Neptune", "Pluto", "Saturn", "Uranus"]
    result = @solar_system.get_planets_with_more_moons(1)
    assert_equal(expected_names, result)
  end
